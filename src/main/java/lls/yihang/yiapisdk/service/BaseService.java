...
import lls.yihang.yiapisdk.exception.ErrorCode;
import lls.yihang.yiapisdk.exception.ErrorResponse;
import lls.yihang.yiapisdk.model.request.BaseRequest;
import lls.yihang.yiapisdk.model.response.ResultResponse;
import lls.yihang.yiapisdk.utils.SignUtils;
import lombok.Data;
...
public abstract class BaseService implements ApiService {
    private YiApiClient qiApiClient;
    /**
     * 网关HOST
     */
     ...
     */
    private Map<String, String> getHeaders(String body, YiApiClient qiApiClient) {
    ...
    @Override
    public <O, T extends ResultResponse> T request(YiApiClient qiApiClient, BaseRequest<O, T> request) throws ApiException {
